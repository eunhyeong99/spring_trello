...
//    private final List<Card> card;
    ...
    public BoardDetailResponseDto(Long boardId, String title, List<ListsResponseDto> listsResponse) {
...
//        this.card = new ArrayList<>();
    ...
    public static BoardDetailResponseDto of(Board board, List<Lists> lists) {
